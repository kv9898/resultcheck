...
`resultcheck` is designed to address this problem by letting you **explicitly track and verify key results** as your analysis evolves. Instead of tracking code, `resultcheck` tracks the **objects** from your analysis.
...
By default, `snapshot()` automatically chooses a representation for the object.
